      ...
      <aside className={"fixed inset-y-0 left-0 z-50 w-64 bg-[#0B0F17] text-[#E2E8F0] border-r border-[#1E2536] flex flex-col justify-between transition-transform duration-300 " + (sidebarOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0")}>
        ...
        <div>
          <div className="p-4 border-b border-[#1E2536] flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className={"w-9 h-9 rounded-xl bg-gradient-to-tr " + "from-amber-400 via-amber-500 to-yellow-600" + " flex items-center justify-center text-white font-black text-sm shadow-md"}>
                SA
              </div>
              <div>
        ...
        <div className="p-3 border-t border-[#1E2536] space-y-2 bg-[#080B10]">
          ...
          <button
            ...
            className="w-full py-2 px-3 rounded-xl bg-slate-900 hover:bg-slate-800 border border-[#222C3E] text-xs font-bold text-[#CBD5E1] flex items-center justify-between cursor-pointer"
          >
